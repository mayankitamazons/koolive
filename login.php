...
if(isset($_GET['redirect'])){
	$back_url_link = $_GET['redirect']; //last visited URL;	
                        ...
                        <div class="resp-tabs-container">
                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                ...
                                <div class="login-top">	
										...
										<input type="hidden" name="back_url_link" id="back_url_link" value="<?php echo $back_url_link;?>"> 
...
-->
                                       ...
                                       <div class="clear"></div> 
        								...
        								<div class="terms_condtions">
        								    <input type="checkbox" name="checkbox" value="check" id="agree" required/> I have read and agree with the 
											<a class="termsss" href="terms.php" target="_blank">"Terms and Conditions"</a> and 
											<a class="termsss" href="privacy.php" target="_blank"> "Privacy Policy"</a>
											& <a class="termsss" href="guideline.php" target="_blank">"Refund Policy"</a>
											& <a class="termsss" href="deliverypolicy.php" target="_blank">"Delivery Policy"</a>
											From KOO.
        								</div>
										<div>
										  Contact us: </br>
Koo Family Sdn. Bhd. (1114536-V)</br>
Telephone number: + 60123945670
										</div>
