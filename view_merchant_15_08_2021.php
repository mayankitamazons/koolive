...
function checktimestatusnew($time_detail)
{
	...
	// die;
    $n = strtolower(date("l"));
	//echo $currenttime."===".$starttime."===".$endttime."===".$day."===".$n;
    ...
    else
    {
        ...
        { ?>
                                    ...
                                    <img src="images/whatapp.png" style="max-width:32px;" /></a>
                                        ...
                                        <span style="color:red;"><?php echo $language['difficulty']; ?> <a href="https://chat.whatsapp.com/Db2atY5JO2v5CMNeiYNs9B" target="_blank">
	...
	.mm_v{
                            ...
                            <div style="display:grid;grid-template-columns:.2fr 2fr;grid-column-gap: 10px;vertical-align: middle;align-content:center;">
                                ...
                                <div class="row">
                                    ...
                                    <div style="float:left;width:80%;margin-left:5%;">
                                        ...
                                        <input class="form-control comment" id="remark_extra" name="remark_extra" placeholder="<?php echo $language['service_time_person']; ?>" style="margin: 0 !important;" value="">
        ...
        { ?>
                            <div class="row " style="min-height: 41px;margin:2%;padding-bottom: 1%;">
                                ...
                                <div class="special_price_value mm_v" style="max-width:60%;box-shadow: rgba(0, 0, 0, 0.16) 0px 2px 5px 0px, rgba(0, 0, 0, 0.12) 0px 2px 10px 0px; font-weight: bold; border-right: 1px solid black; padding-top: 2%; padding-bottom: 1%; background:rgb(81, 210, 183) none repeat scroll 0% 0%; color: rgb(85,85,85);">
        ...
        { ?>
                            <div class="row sp_main_div" style="min-height: 41px;margin:2%;padding-bottom: 1%;">
                                ...
                                <div class="speed_price_value mm_v" style="max-width:60%;box-shadow: rgba(0, 0, 0, 0.16) 0px 2px 5px 0px, rgba(0, 0, 0, 0.12) 0px 2px 10px 0px; font-weight: bold; border-right: 1px solid black; padding-top: 2%; padding-bottom: 1%; background:rgb(81, 210, 183) none repeat scroll 0% 0%; color: rgb(85,85,85);">
...
<div class="">		
							<div class="row" style="min-height: 41px;margin:2%;padding-bottom: 1%;">
                                <div class="donation_button mm_v"  style="max-width:60%;box-shadow: rgba(0, 0, 0, 0.16) 0px 2px 5px 0px, rgba(0, 0, 0, 0.12) 0px 2px 10px 0px; font-weight: bold; border-right: 1px solid black; padding-top: 2%; padding-bottom: 1%; background:rgb(81, 210, 183) none repeat scroll 0% 0%; color: rgb(85,85,85);">
...
?>
                                ...
                                <input type="number" autocomplete="tel" maxlength='10' id="mobile_number" style="max-width:220px;" class="mobile_number form-control" value="<?php if ($check_number)
        {
            echo $check_number;
									...
									<a href="javascript:void(0)" class="btn btn-primary send_otp_button" name="send_otp_button" style="display: none;">SEND OTP</a>
...
<br/>
							...
							echo ucfirst(strtolower($chinese_man)); ?>: Rm <span id="special_delivery_label_text"></span>
                                    ...
                                    <div class="" style="display:none;" id="delivery_label">
                                        <div style="grid-template-columns:.2fr 2fr;grid-column-gap: 10px;vertical-align: middle;align-content:center;font-weight: bold;font-size: 15px;margin-top:1%;">
                                            ...
                                            <?php echo ucfirst(strtolower($deliver_charges_label)); ?>: Rm <span id="order_extra_label"><?php echo number_format($merchant_detail['order_extra_charge'], 2) - $discount_offer_minus; ?></span>
											<br/>
        ...
        echo ucfirst(strtolower($payable_amount)); ?>: Rm <span class="final_amount_value"><?php echo number_format($merchant_detail['order_extra_charge'], 2)- $discount_offer_minus;; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div style="width:15%">
                                    ...
                                    <a href="https://chat.whatsapp.com/FdbA1lt6YQVBNDeXuY7uWd" target="_blank"><img src="images/iconfinder_support_416400.png" style="width:50px;height:auto;"></a>
		...
		<i class="fa fa-cart-plus" aria-hidden="true"></i> &nbsp;&nbsp;<?php echo 'Checkout';//$language["order_confirm_button"]; ?>
                        ...
                        <div class="row main_box_div mode_btn_hide ">
							...
							<div class="row main_btn_div">
								...
								<input type="hidden" id="payment_proof_name" name="payment_proof_name" value="">
                                ...
                                <input type="hidden" value='<?php echo $login_user_id; ?>' name="login_for_wallet_id" id="login_for_wallet_id" />
								 ...
								 <?php if ($_SESSION['block_pay'] !== "y"){ ?>
								  ...
								  <?php }else{?>
								  <div class="col-xs-4 pdbtn-10" >
										<a  class=" show_restriction each_mode_btn_hide block_pay_btn btn-lg btn btn-block btn-primary" name="" actual_payment_mode="cash" style="display: block;background-color: #ef6264;border-color: #ef6264; width: 268px !important; margin-top: 15px;    box-shadow: -3px 3px #fa7953, -2px 2px #fa7953, -1px 1px #fa7953;">
											<i class="fa fa-money"></i>&nbsp;&nbsp;<?php echo $language["confirm_order"]; ?>
										</a>
									</div>
								  ...
								  <?php }?>
									...
									<div class="col-xs-4 pdbtn-10">
										<button type="submit" actual_payment_mode="wallet" class="each_mode_btn_hide wallet_od_btn mode_btn_hide third_order_btn btn btn-block btn-primary submit_button online_pay btn-lg" name="cashpayment" style="display: block;">
											<i class="fa fa-shopping-bag"></i>&nbsp;&nbsp<?php if ($login_user_id)
											{
											...
											else
											{
												...
												echo $language['confirm_wallet_login']."<span class='wallet_ajax_value'>".$language['confirm_wallet_login_only_member']."</span>";
											}
											if ($_SESSION['login'])
											{
              ...
              <!--  <button class="btn btn-large btn-danger make_payment showLoader8">CASH</button>
				...
				<div class="row" style="margin: 0;padding: 0;">
					  <div class="col-12 col-sm-6 cash_wallet_f_main" style="margin: 0px;padding: 0;margin-top: 10px;">
						...
						<?php }else{?>
						<a  class=" show_restriction no_need_paymnetoptions btn btn-primary " name="" actual_payment_mode="cash" style="width: 98%;padding-left:11px;background: #03a9f3;border-color: #03a9f3;">
					  ...
					  <div class="col-12 col-sm-12" style=" margin: 0;padding: 0;margin-top: 10px;">
						<button class="btn btn-large btn-primary" style="width: 98%;padding-left:11px;background: green;border-color: green;" data-dismiss="modal">Cancel </button>
					  </div>
				</div>
						...
						<div class="row">
							...
							<div class="col-md-12 pad0">
								...
								<div style="width: 100%;text-align: center;">
									<img class="img-responsive Sirv" data-src="https://koofamilies.sirv.com/qr_code.png" />  
								</div>
							...
							<form method="post" id="image-form" class="image-form"  enctype="multipart/form-data" onSubmit="return false;" style="min-height:0px !important;">
								<div class="input-group mt-3 mb-3 input-has-value flex-wrap1 main_image_div" id="main_image_div">
									...
									<button type="button" class="browse btn btn-primary rounded-0" style="width: 80px;">Browse</button>
									&nbsp;
							...
							<p style="color:blue;font-size: 13px;margin-top: -30px;">
							<?php echo $language['payment_prrof_text']; ?></p>
      ...
      <div class="modal fade" id="show_restriction_popup" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						<h5>During this pandemic, we are unable to proceed with Cash on Delivery for a safety purposes of riders and customers.<h5>
                    </div>
					<div class="modal-footer login_footer" style="padding:0px;">
						 <button type="button" class="btn btn-primary" style="font-size:14px;min-width:50px;margin-top:1%;color:white"  data-dismiss="modal"><?php echo $language['skip']; ?></button>
					</div>
                </div>
            </div>
        </div>
...
$(".each_mode_btn_hide").click(function(e) {
		...
		$('#ajaxresDiv input[name="ingredients"]').each(function() {
...

                                        {
...

                                            {
                                                ...
                                                if (membership_discount_input){
												 ...
												 $('#show_msg_new').html('Rm '+ data.data.koocash_wallet +'<span style="color:black"> is inside your wallet. Please login to use it.</span>');
												}
                                                else{
