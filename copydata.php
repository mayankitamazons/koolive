				...
				if($varient_exit=="y")
				{
				   ...
				   //sub product copy
					...
					while ($row2=mysqli_fetch_assoc($query2)){
						...
						mysqli_query($conn, "INSERT INTO sub_products SET product_id='$new_product_id',name='$p_name',product_price='$product_price',product_type='$product_type',status='$status', merchant_id = '$merchant_id'");
...
<div class="container">
  ...
  <form method="post" action=''>
    ...
    <small><b>Note : That tool copy Category Master ,Category , Product , Sub Product, timing</b></small>
