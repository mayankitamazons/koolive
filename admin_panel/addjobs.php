...
if(isset($_POST['add-job'])){
    ...
    $query = mysqli_query($conn, "INSERT INTO `jobs`(`title`, `job_desc`, `price`, `posted_date_utc`, `expire_date_utc`, `job_category_id`, `job_provider_name`, `job_provide_mobile`, `job_provider_desc`) VALUES ('$title','$jobDesc','$jPrice','$post_date','$expire_date','$category','$jProname','$jProNo','$jobProDesc')");
        ...
        <div class="container">
            ...
            <form action="addjobs.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" required name="jPrice" class="form-control"  placeholder="Price">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="jProname" class="form-control"  placeholder="Job Provide Name">
                </div>
                <div class="form-group">
                    <label for="title">Job Provider Contact <span style="color:red;">*</span></label>
                    <input type="tel" required  maxlength=10 pattern="[0-9]{10}" required name="jProNo" class="form-control"  placeholder="Job Provide Mobile">
                </div>
                <div class="form-group">
                ...
                <button type="submit" name="add-job" class="btn btn-lg btn-outline-primary">Submit</button>
            </form>
        </div>
