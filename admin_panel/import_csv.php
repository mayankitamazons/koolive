                ...
                <div class="container-fluid" id="main-content" style="padding-top:25px">
				   <div class="container">
						<div class="card">
							...
							<h2  style=" background: red;color: white; padding: 12px;">Please Take Database backup, before upload XLSX!!!</h2>				
							...
							<form action="db_csv.php" method="POST" class = "form-inline1 form_csv" role = "form" enctype="multipart/form-data">
								...
								<div class = "form-group">
									<select class="form-control" name="city_name" id="city_name" style="width:170px" >
								...
								<div class = "form-group">
									<select class="form-control" name="language_name" id="language_name" style="width:170px" >
										<option value="0">Select Language</option>
										<option value="1">Chinese</option>
										<option value="2">English(Encoding)</option>
                                    </select>
								</div>
								<br/>
...
$(document).ready(function(){
	...
	$(".form_csv").submit(function(){
		...
		$("#language_name").css({border: ''});
		
		if(city_name  == 0){
			$("#city_name").css('border','2px solid red');
			return false;
		}else if(language_name  == 0){
			$("#language_name").css('border','2px solid red');
			return false;
