...

{
 ...
 $q="SELECT * FROM coupon WHERE user_id='".$_SESSION['login']."'";
      
$u_query =mysqli_query($conn,"SELECT * FROM coupon WHERE user_id='".$_SESSION['login']."'");
            ...
            <main class="main-wrapper clearfix" style="min-height: 522px;">
                ...
                <div class="row" id="main-content" style="padding-top:25px">
					...
					<div class="well" style="width:100%">
						...
						<h3><?php echo $language["coupon_code_list"];?> <a href="addcoupon.php" class="btn btn-primary pull-right"><?php echo $language["add_coupon_code"];?></a></h3>
						...
						<table class="table table-striped kType_table dataTable no-footer" id="kType_table" aria-describedby="kType_table_info">
							...
							<tr>
								<th><?php echo $language["coupon_code"];?></th>
...

							{
                        	    ...
                        	    <td>
									<a class="mr-4" href="view_coupon.php?coupon_id=<?php echo $row['id'] ?>">
									<i class="fa fa-eye" aria-hidden="true"></i>
									</a>
									<a class="mr-4" href="edit_coupon.php?coupon_id=<?php echo $row['id'] ?>">
