										...
										<div class="n_order_body form-row">
											<div class="n_order_mer col-lg-12">
												<div class="n_mer_name">
													...
													<br>
													<?php if($fetchData['table_type'] != ''){?>
													<span class="fnt13"><b>Table</b>: <?php echo $fetchData['table_type'];?></span> &nbsp;&nbsp;| &nbsp;&nbsp;
													<?php }?>
													<?php if($section_type['name'] != ''){?>
													<span class="fnt13"><b>Section</b>: <?php echo $section_type['name'];?></span>
													<?php }?>
						...
						?>
										<?php if($fetchData['cancel_order'] == 1){?>
											...
											<div class="n_breadcrumb flat d-flex">
												<?php if($fetchData['rider_complete_order'] == 1){?>
											...
											<?php }else if($fetchData['status'] == 1){?>
												<a href="#" class="active">Pending</a>
												<a href="#" class="active">Accepted</a>
												<a href="#" class="">In delivery</a>
												<a href="#" class="">Completed</a>
											<?php }else if($fetchData['status'] == 4){?>
												<a href="#" class="active">Pending</a>
												<a href="#" class="active">Accepted</a>
												<a href="#" class="active">In delivery</a>
												<a href="#" class="">Completed</a>
											<?php }else if($fetchData['status'] == 2){?>
												<a href="#" class="active">Pending</a>
												<a href="#" class="active">Accepted</a>
												<a href="#" class="">In delivery</a>
												<a href="#" class="">Completed</a>
														...
														<tr>
															...
															<td data-label="Products" class="secnd-head"><?php echo $product['product_name'];?>
																...
																<p class="moretext" id="moretext_<?php echo $key;?>">
																	<?php if($product_code[$j] != ''){?>
																	<span>
																	<strong>Code : </strong> <?php echo $product_code[$j];?></span><br/>
																	<?php }?>
							...
							if($fetchData['special_delivery_amount']>0 && $fetchData['speed_delivery_amount']>0){
								//echo '1';
								echo @number_format($fetchData['od_extra_charge'],2)."+ ".number_format($fetchData['special_delivery_amount'],2)."(Chiness Delivery)"."</br>+".number_format($fetchData['speed_delivery_amount'],2)."(Speed Delivery)"."+".@number_format($territory_price,2);
								
								
								}
								else if($fetchData['special_delivery_amount']>0 && $fetchData['speed_delivery_amount']==0){
								//echo '2';
								echo @number_format($fetchData['od_extra_charge'],2)."+ ".number_format($fetchData['special_delivery_amount'],2)."(Chiness Delivery)"."+".@number_format($territory_price,2);
									
								}
								else if($fetchData['special_delivery_amount']==0 && $fetchData['speed_delivery_amount']>0){
									//echo '3';
									echo @number_format($fetchData['od_extra_charge'],2)."+ ".number_format($fetchData['speed_delivery_amount'],2)."(Speed Delivery)"."+".@number_format($territory_price,2);
								}
								else {
									//echo '4';
									//echo "..".$row['order_extra_charge'];
									echo @number_format($fetchData['od_extra_charge'],2)."<br/>+<br/>".@number_format($territory_price,2); 
									} ?>
									<br/>
									<?php if($terr_id == '-1'){?>
								...
								<?php if($fetchData['free_delivery_prompt'] == 1){?>
