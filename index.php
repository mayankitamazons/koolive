...
display:none;
		...
		<div class="row service_main_item_inner">
					<?php 
						$class_query = "SELECT * FROM `classfication_service` where status = 'y'";
						...
						<div class="col-lg-2 col-4">
							<div class="service_m_item">
								...
								<div class="service_text">
									<a href="javascript:void(0)" class="more_category" category="more_cat"><h4 class="more_cat_text">More categories</h4></a>
								</div>
							</div>
						</div>
...
<script>
			$(document).ready(function(){
				$(".more_category").on("click", function () {
					...
					var txt = $(".more_category_box").is(':visible') ? 'More categories' : 'Hide categories';
