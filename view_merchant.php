        ...
        { ?>
            ...
            <label class="head_loca" style="display:grid;align-content:center;text-align:left;"><?php echo $language['delivery_location']; ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <a  data-toggle="modal" class="btn btn-primary" data-target="#location_map_fetch" onclick="currentLocation();">Fetch Map</a>
...
?>
      ...
      <div class="col-md-4 form-group">
        ...
        { ?>
            ...
            {
                echo $language['confirm_wallet_with_login'];
            }
            else
            {
        ...
        if ($merchant_detail['internet_banking'])
        { ?>
                                <div class="col-xs-3" style="margin-left:1%;">
            ...
            <div class="modal-body" style="padding-bottom:0px;padding: 0px;">
                <div class="col-md-12" >
                  ...
                  <div id="map_loacation_warper">
                    Marked Location:<input class="input-box-330" type="text" name="location" id="location" value="<?php if( $locationData){echo $locationData['address'];}?>" readonly>
...
{
    echo "Congratulation,Please login to use $special_coin_name wallet."; ?>
...
{
    echo "Congratulation, your order is completed. Please login to use KOO Coin wallet.";
} ?>
                    ...
                    <div class="wallet_mode" style="display:none;">
                        ...
                        <div class="card-body wallet_select" wallet_name="MYR" type="myr_bal">MYR <br> <span  id="myr_bal"><?php if (isset($urecord['balance_myr']))
{
    echo $urecord['balance_myr'];
} ?></span></div>
                    </div>
                    <div style="margin: 2%;max-height: 80px;text-align: left;padding: 0%;" class="col-md-3 card bg-info text-white">
                        <div class="card-body wallet_select" wallet_name="CF"  type="usd_bal">CF <br> <span id="usd_bal"><?php if (isset($urecord['balance_usd']))
{
    echo $urecord['balance_usd'];
} ?></span></div>
                    </div!-->
...
{ ?>
                                ...
                                <div style="margin: 2%;max-height: 80px;text-align: left;padding: 0%;font-size: 13px;" class="col-md-7 card bg-info text-white">
                                    ...
                                    <div class="card-body wallet_select" wallet_name="<?php echo $special_coin_name; ?>" type="special_bal" style="color:black;padding:1.00rem !important;font-size: 18px;">
                                        ...
                                        <?php echo $special_coin_name; ?> RM <span id="special_bal" style="color:red;font-weight:bold;"><?php if (isset($special_bal))
    {
        echo number_format($special_bal, 2);
    } ?></span>
...
{ ?>
                                ...
                                <div style="margin: 2%;max-height: 80px;text-align: left;padding: 0%;font-size: 13px;" class="col-md-7 card bg-info text-white">
                                    ...
                                    <div class="card-body wallet_select" wallet_name="KOO COIN" type="inr_bal" style="color:black;padding:1.00rem !important;font-size: 18px;">
                                        ...
                                        KOO COIN RM <span id="inr_bal" style="color:red;font-weight:bold;"><?php if (isset($balance_inr))
    {
        echo number_format($balance_inr, 2);
    } ?></span>
                ...
                <div id="login_process">
                    ...
                    <div class="forgot-form" style="display:none;">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" autocomplete="tel" maxlength='10' id="user_mobile" class="mobile_number form-control" <?php if ($check_number)
{
    echo "readonly";
