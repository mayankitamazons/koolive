...
$share_url = $site_url. "view_merchant.php?sid=" . $sid . "&vs=" . md5(rand());
...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <style>
        ...
        .3button {
            box-shadow: -3px 3px #35cbab, -2px 2px #00736A, -1px 1px #00736A !important;
...
*/
        ...
        img.lazy {
            ...
            background-image: url('https://mysafehouse1.co/img/logo.png');
...
*/
        ...
        @media only screen and (max-width: 576px) {
            input.btn.btn-block.btn-primary.submit_button.online_pay {
                margin-left: 10px;
            }
...
border: 1px solid #fa7953;background:red;color:black !important;margin-top: 3%;padding:10px;" href="index.php?vs=<?=md5(rand()) ?>"><?php echo $language['more_shops']; ?>
                ...
                <div class="col-md-12 row favorite" style="margin-left:15px; margin-bottom: 10px; padding-left:0px;">
                    ...
                    <div class="favbx" style="clear:both;">
    ...
    { ?>
                            ...
                            <script>
                                window.location.replace("https://www.mysafehouse1.co/merchant_find.php");
                            </script>
...
?>
    ...
    else
    {
        ...
        { ?>
                    ...
                    <div class="favorite_icon heartbx">
...
?>
    ...
    <main class="main-wrapper clearfix" style="min-height: 522px;">
        ...
        { ?>
            ...
            <form method="post" id="order_place" action="order_cash.php" autocomplete="off">
        ...
        { ?>
                        ...
                        <div class="name_mer">
                            ...
                            <div style="display:grid;grid-template-columns:.2fr 2fr;grid-column-gap: 10px;vertical-align: middle;align-content:center;>
                                ...
                                <div class="row deliverybx">

                                    <?php $deliver_place = "Delivery Address *"; ?>
            <label class="head_loca"><?php echo $language['delivery_location']; ?></label> 
                                    ...
                                    <a  class="btn btn-primary" onclick="pastaddress();"><?php echo $language['saved_address']; ?></a>  <div class="address-field" style="float:left;width:80%;margin-left:5%;">
                                        <input class="form-control comment addressbx" id="mapSearch" name="location" placeholder="<?php echo $language['full_address']; ?>" style="margin: 0 !important;">
                                    </div>
...
#search-box{padding: 10px;border: #a8d4b1 1px solid;border-radius:4px;}
						...
						<div class=" postalbx">
							<label class="post_code" style="display:grid;align-content:center;text-align:left;">Area/Postcode *</label>
							<div class="row">
								<div style="float:left;width:80%;margin-left:5%;" class="">
									<input type="hidden" name="territory_hidden_id" id="territory_hidden_id" val=""/>
									<input type="hidden" name="merchant_territory_hidden_id" id="merchant_territory_hidden_id" val="<?php echo $merchant_detail['m_territory_id'];?>"/>
									<!--
									...
									<option value="">Select Area/Postcode</option>
									<?php while ($srow=mysqli_fetch_assoc($total_rows)){
										$price = $srow["t_price"] + $merchant_detail['order_extra_charge'];
										$price = number_format($price, 2);
		?>
										<option value="<?php echo $srow["t_id"];?>" price_optn='<?php echo $srow["t_price"];?>'><?php echo $srow["t_location_name"].' ('.$srow["t_postcode"].') - RM '.$price;?></option>
									<?php }?>
									<option value="-1" price_optn="0.00">Others</option>
									</select>
        ...
        { ?>
                        ...
                        <div class="container">
							...
							echo ucfirst(strtolower($chinese_man)); ?>: Rm <span id="special_delivery_label_text"></span>
								...
								<!---postcode--->
									<div class="" style="display:block;" id="postcode_delivery_charge">
                                        <div style="grid-template-columns:.2fr 2fr;grid-column-gap: 10px;vertical-align: middle;align-content:center;font-weight: bold;font-size: 15px;margin-top:1%;">
                                            Outstation charges: Rm <span id="postcode_delivery_charge_price">0.00</span>
                                        </div>
...
<div class="row main_box_div mode_btn_hide ">
	...
	<div class="row main_btn_div">
		...
		<div class="col-xs-4 pdbtn-10">
			<button type="submit" class="each_mode_btn_hide block_pay_btn btn-lg btn cash_od_btn btn-block btn-primary showLoader submit_button" name="cashpayment" id="confm" style="display: block;">
		...
		<div class="col-xs-4 pdbtn-10">
			<button type="submit" class="each_mode_btn_hide banking_od_btn mode_btn_hide internet_banking_btn btn btn-block btn-primary submit_button internet_banking btn-lg" name="internet_banking" style="display: block;">
		...
		<div class="col-xs-4 pdbtn-10">
			<button type="button" class="each_mode_btn_hide mode_btn_hide btn btn-block btn-primary submit_button btn-lg internet_banking_fpx banking_od_btn" name="internet_banking_fpx" style="display: block;">
		...
		<div class="col-xs-4 pdbtn-10">
			<button type="submit" class="each_mode_btn_hide wallet_od_btn mode_btn_hide third_order_btn btn btn-block btn-primary submit_button online_pay btn-lg" name="cashpayment" style="display: block;">
				<i class="fa fa-shopping-bag"></i>&nbsp;&nbsp;<?php if ($login_user_id)
            {
...
<?php /*?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-4" style="margin-left:1%;">
								...
								<button type="button" class="btn btn-primary"  id="order_confirm_btn" session_block_pay ="<?php echo $_SESSION['block_pay'];?>" internet_banking ="<?php echo $merchant_detail['internet_banking'];?>" value="">
								<i class="fa fa-cart-plus" aria-hidden="true"></i> &nbsp;&nbsp;<?php echo 'Checkout';//$language["order_confirm_button"]; ?></button>
...
<button type="submit" class="mode_btn_hide block_pay_btn btn-lg btn cash_od_btn btn-block btn-primary showLoader submit_button" name="cashpayment" id="confm" >
<i class="fa fa-money"></i>&nbsp;&nbsp;<?php echo $language["confirm_order"]; ?></button>


                                    <!--<input type="submit" style="width:100% !important;box-shadow: -3px 3px #35cbab, -2px 2px orange, -1px 1px orange;border: 1px solid #35cbab;" class="mode_btn_hide block_pay_btn btn btn-block btn-primary showLoader submit_button" name="cashpayment" id="confm" value="<?php echo $language["confirm_order"]; ?>">-->
        ...
        { ?>
                                <div class="col-xs-4" style="margin-left:1%;">
                                    <!--<input type="submit" style="margin-top:3%;width:100% !important;box-shadow: -3px 3px #35cbab, -2px 2px orange, -1px 1px orange;border: 1px solid #35cbab;" class="mode_btn_hide internet_banking_btn btn btn-block btn-primary submit_button internet_banking" name="internet_banking" value="<?php echo $language['internet_banking']; ?>" />-->
									
									<button type="submit"  class="banking_od_btn mode_btn_hide internet_banking_btn btn btn-block btn-primary submit_button internet_banking btn-lg" name="internet_banking"  ><i class="fa fa-bank"></i>&nbsp;&nbsp;<?php echo $language['internet_banking'];?></button>
                            ...
                            <div class="col-xs-4 online_label" style="margin-left:1%;">   
                                ...
                                <button type="submit"  class="wallet_od_btn mode_btn_hide third_order_btn btn btn-block btn-primary submit_button online_pay btn-lg" name="cashpayment"  ><i class="fa fa-shopping-bag"></i>&nbsp;&nbsp;<?php if ($login_user_id)
            {
                echo $language['confirm_wallet'];
            }
            else
                ...
                else
                {
                    if ($user_koo_coin)
                    {
                       // echo number_format($user_koo_coin, 2);
                                ...
                                <!--    <input type="submit" style="width:100% !important;box-shadow: -3px 3px #35cbab, -2px 2px orange, -1px 1px orange;border: 1px solid #35cbab;" class="mode_btn_hide third_order_btn btn btn-block btn-primary submit_button online_pay" name="cashpayment" value=' /*if ($login_user_id)
            {
                echo $language['confirm_wallet'];
            }
            else
...
<?php if (!empty($ipay88_fields)): ?>
  ...
  <?php endif; ?>
				<!--<form action="<?php echo Ipay88::$epayment_url; ?>" method="post" id="ipay88_form">
					<input type="hidden" name="MerchantCode" id="merchantcode" value="M31571">
					<input type="hidden" name="PaymentId" id="paymentid" value="">
					<input type="hidden" name="RefNo" id="refNo" value="IPAY0000000001">
					<input type="hidden" name="Amount" id="amount" value="1.00">
					<input type="hidden" name="Currency" id="currency" value="MYR">
					<input type="hidden" name="ProdDesc" id="proddesc" value="koofamilies_merchnt_product">
					<input type="hidden" name="UserName" id="username" value="usernumber1">
					<input type="hidden" name="UserEmail" id="useremail" value="email@example.com">
					<input type="hidden" name="UserContact" id="usercontact" value="0123456789">
					<input type="hidden" name="Remark" id="remark_ipay88" value="this is testing product and orderid #1">
					<input type="hidden" name="Lang" id="lang" value="UTF-8">
					<input type="hidden" name="Signature" id="signture" value="<?php echo $payment_signature;?>">
					<input type="hidden" name="ResponseURL" id="responseurl" value="https://mysafehouse1.co/demo2/order_cash.php">
...
<div id="view_cart">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 p-media">

                                    <div class="view_bg">

                                        <h5><b id="totalItem" data-value="0"> 0</b> ITEMS | Rm <span data-value="0" id="totalPrice">0</span></h5>

                                        <h6 data-toggle="modal" data-target="#myModal">View Cart<img src="images/view-cart.svg" alt=""></h6>
        ...
        <div class="form-group">
            <div class="modal-content">
                <div class="modal-header" style="padding-top: 0;padding-bottom: 1px;">
					<h5>Pay with Internet Banking</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
					...
					<div class="container-fluid pad0">
						<div class="row">
							...
							<div class="col-md-11 pad0">
								...
								<b>Bank name:</b>  Maybank <br/>
								<b>Bank account:</b>  511234010582 <br/>
								...
								<b>Enquiry</b>  <a href="https://api.whatsapp.com/send?phone=601159223660" target="_blank"> 601159223660 <img src="https://www.mysafehouse1.co/images/whatapp.png" style="max-width:32px;" /> </a></br>
							</div>
							<?php }else{?>
							<div class="col-md-12 pad0">
								<b><?php echo $language['name']; ?>:</b> Chong Woi Joon </br>
								<b>Bank name:</b> Hong Leong Bank </br>
								<b>Bank account:</b> 22850076859 </br>
							</div>
							...
							<div class="col-md-12 pad0">
								...
								<b>Enquiry:</b> <a href="https://chat.whatsapp.com/LdvomJRqXoIG6aXqsf5PgX" target="_blank" style="font-size:12px"><img src="https://www.mysafehouse1.co/images/whatapp.png" style="max-width:23px;" />https://chat.whatsapp.com/LdvomJRqXoIG6aXqsf5PgX</a><br/>
							</div>
							<?php }?>
							<div class="col-md-12 pad0">
				...
				<div class="modal-footer" style="padding-top: 10px;padding-bottom: 10px;border-bottom:none">
					...
					<button type="button" class="btn btn-primary trasfer_complete showLoader"><?php echo $language['confirm_order']; ?><span></span></button>
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
...

                {
                    ...
                    window.location.replace("https://www.mysafehouse1.co/orderlist.php");
    ...
    $("#paypal_close").click(function(e) {
        ...
        window.location.replace("https://www.mysafehouse1.co/view_merchant.php");
...
$shortcut_icon = 'https://mysafehouse1.co/img/logo_512x512.png';
...
<script>
    $(window).on('load', function() {
        ...
        $('.lazy').lazy({
            ...
            placeholder: "https://mysafehouse1.co/img/logo.png"
        });
    ...
    // alert(total_work);
...

        {
            ...
            // window.location.replace("https://www.mysafehouse1.co/favorite.php");
        ...
        $("#no_button").click(function(e) {
            ...
            var r_url = "https://www.mysafehouse1.co/index.php?vs=" + s_token;
...
////////////////Custom js////////////////////
  var icon =  jQuery('.favorite_icon').wrapAll();
    jQuery('.favbx h4 > a img').before(icon);
    console.log('add');
});
