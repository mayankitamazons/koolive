...
<body class="header-light sidebar-dark sidebar-expand pace-done">
	...
	<tr style="<?php if($color){ echo "color:".$color;} ?>">
      ...
      if(!empty($row['image']))
      { ?>
              <td><img src="<?php echo $image_cdn; ?>product/<?php echo $row['image'];  ?>?w=200" ></td>  
   ...
   <?php }
      ...
      if(!empty($row['image']))
      { ?>
              <td><img src="<?php echo $image_cdn; ?>product/<?php echo $row['code'];  ?>?w=200" ></td>  
...
<!--End  Stock Model !-->
    ...
    <div class="modal-dialog">
      ...
      <div class="form-group">
		...
		<img src="<?php echo $site_url; ?>/images/remove.png" style="width: 24px;height: 24px;margin-left: 14%;" id="remove_image"/>
		
	    <div id ="picture"></div>
	    <input type="file" class="save" name="image_pic">
      
		</div>
        <div class="form-group">
          <label>Select Code</label><br>
          <div id ="picture_code"></div>
          <input type="file" class="save" name="image_code">
...
-->
 ...
 <div class="modal fade" id="myModal" role="dialog" >
  ...
  $(".pop_up").click(function(){
      ...
      $("#picture").html("");
      $("#picture_code").html("");
       $("#picture").append('<img src="<?php echo $image_cdn; ?>product/'+response.image+'?w=80'+'"   class="test_st">');
       $("#picture_code").append('<img src="<?php echo $image_cdn; ?>/images/product_images/'+response.code+' " width="50" height="50"  class="test_st">');
