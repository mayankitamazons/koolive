...
// }
  ...
  //http://188.166.187.218/orderlist.php?payid=12085&vs=6f493a2d2155f8e45b670d8b3b0d938f
               ...
               <tbody>
                  ...
                  <tr  data-id="<?php echo $row['order_id']; ?>" class="<?php echo $todayorder; ?> <?php echo $callss; ?> br_bk" >
					...
					?>
						...
						<?php if($row['rider_arrive_shop'] != '0000-00-00 00:00:00'){?>
...
if ('serviceWorker' in navigator) {
 ...
 $(".forgot_pass").click(function(){
   ...
   $(".skiponline").click(function(){
     var s_token=generatetokenno(16);
						var r_url="http://188.166.187.218/orderlist.php?vs="+s_token;
