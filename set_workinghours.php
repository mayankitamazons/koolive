...
$bank_data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SQL_NO_CACHE * FROM users WHERE id='".$_SESSION['login']."'"));
...
if(isset($_POST['submit']))
{
	...
	{	
		$sql = "select SQL_NO_CACHE * from set_working_hr where merchant_id =$current_uid";
