...
<div id="wrapper" class="wrapper">
                        ...
                        <div class="title">
                            ...
                            { ?>
                               ...
                               <div class="view-merchant-image">
                                <div class="bg-image">
                                   <div class="fav-icon favorite_icon">
                                    <?php if ($count > 0){ ?>
                                        <i class="heart fa fa-heart"></i>
                                    <?php } else{ ?>
                                     <i class="heart fa fa-heart-o"></i>
                             ...
                             <div class="view-all-shop">
                                <h6><a href="index.php?vs=<?=md5(rand()) ?>" style="padding-right: 4px; padding-left: 5px;"> <?php echo $language['more_shops']; ?> 
							...
							<?php  $file_pointer = "https://koofamilies.sirv.com/about_images/".$merchant_detail['image'];?>
  ...
  <?php   if ($merchant_detail['chat_with_merchant']){
      if ($merchant_detail['chat_group']){ ?>
         <a href="<?php echo $merchant_detail['chat_with_merchant']; ?>" target="_blank">
            <img src="images/whatapp.png" style="max-width:32px;">
        </a>
    <?php } else { ?>
     <a href="https://api.whatsapp.com/send?phone=<?php echo $merchant_detail['chat_with_merchant'] ?>" target="_blank"> <img src="images/whatapp.png" style="max-width:32px;"></a>
 <?php } } else {
  ...
  if (in_array($merchant_detail['id'], $chat_merchant_list))
     { ?>
         <a href="https://chat.whatsapp.com/J4wcS4riADaBBrvY60c8f3" target="_blank"> <img src="images/whatapp.png" style="max-width:32px;"></a>
     <?php }else{ ?>
      <a href="https://api.whatsapp.com/send?phone=<?php echo $merchant_detail['mobile_number'] ?>" target="_blank"> <img src="images/whatapp.png" style="max-width:32px;"></a>
  <?php } } ?>
</h2>
										<!--
										<div class="download-google-wrap">
            ...
            <!-- <p class=" empty-text"> The cart is empty</p> -->
             ...
             <div class="cart-details-wrapper cart_wrapper" id="cartsection">
                  ...
                  foreach($_SESSION['AjaxCartResponse'][$cart_merchant_id] as $cart_key => $cart_val){
                   ...
                   <?php if($cart_val['sub_varient']!= ''){?>
                      <div class="varient_list" >
                       <p class="moretext va_sub" id="moretext_<?php echo $cart_val['id']."_".$product_pre_exit;?>" style="display:none"><?php echo $cart_val['sub_varient'];?></p>
               ...
               <div class="cart-d-cell">
                   ...
                   <p class="price-text"><strong>Total : </strong>RM <span class="p_span_total <?php echo $cart_val['id'];?>_cat_total"><?php echo $cart_val['p_total'];?></span></p>
               </div>
           </div>
...
<!-- ENd Postcode-->
<div class="name_remakr" style="margin-top: 10px;">
    <div>
...
<div style="display:none;float: left;" id="table_show">
                ...
                <div class="modal-footer login_footer" style="padding: 0;margin: 0;padding-top: 20px;padding-bottom: 20px;">
                 <div class="row" style="margin: 0;padding: 0;">
                   ...
                   <div class="col-12 col-sm-5 lgn_div_otp" style="margin: 0px;padding: 0;margin-top: 10px;">
                      <span class="btn btn-primary login_with_otp myBtnLogWithOTP" id="myBtnLogWithOTP" style="width: 98%;background: border-box; color: grey;"><?php echo $language['login_with_otp']; ?></span>
                  </div>
...
if(f_html != ''){
	$subvarientsHtml = '<div class="varient_list" ><p class="moretext va_sub" id="moretext_'+ id +'_'+$rand_iddds+'" style="display:none">'+ f_html +'</p><a class="moreless-button moreless-button_'+ id +'_'+$rand_iddds+'" href="javascript:void(0)" product_id="'+ id +'_'+$rand_iddds+'">Read more</a></div>';
}
...
$cart_html1 = "<input type='hidden' name='rebate_amount[]' class='rebate_amount' value=" + rebate_amount +" id='"+ id +"rebate_amount'><input type='hidden' name='rebate_per[]' value="+ rebate_per + " id='"+ id +"rebate_per'><input type= hidden name='p_id[]' value= "+ id +"><input type= hidden name='p_code[]' value= "+ code +"><input type='hidden' name='ingredients' value='"+ single_remarks +"'/><input type='hidden' name='varient_type[]' value="+ varient_type +"><input type='hidden' id='"+ extra_child_id +"' name='extra' value='"+ extra_price +"'><input type='hidden' style='width:70px;' class='p_total' name='p_total[]' value= "+p_total+" readonly  id='"+ id +"_cat_total'><input style='width:70px;' type='hidden' name='p_price[]' value='"+ product_price + "' readonly><input style='width:70px;text-align:right;' type='hidden' name='p_extra' id='"+ extra_child_id + "' value='"+ extra_price +"' readonly>";
