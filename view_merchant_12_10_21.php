...
<div class="row mb-3">
	<div class="" style="margin-left:20px;display:block">
		...
		<a class="btn btn-primary search_button" style="margin-left:10px;padding-left:6px;padding-right:6px" viewFile="<?php echo $viewFile;?>" merchant_id = "<?php echo $id;?>" prduct_qty="<?php echo $product['pro_ct'];?>" dataRedirectLink = "<?php echo $URLENCODE;?>" price_hike="<?php echo $merchant_detail['price_hike'];?>" >Search</a>
             ...
             <div class="container-fluid pad0">
              <div class="row">
               <h6 style="font-size:16px;margin-top:8px"><?php echo $language['please_pay_exact_amount']; ?>  <span style="color:red">Rm <span style="font-weight:bold;color:red" class="final_amount_value internet_free_modal_amount"></span>
				...
				<a class="showing_internetfree_offer" style="display: inline-flex;" href="javascript:void(0)" title="To encourage contactless to combat Covid-19, we offer Rm0.50 discount for internet banking" data-toggle="tooltip" data-placement="bottom" title="To encourage contactless to combat Covid-19, we offer Rm0.50 discount for internet banking">
