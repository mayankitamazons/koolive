...

{
	...
	<header class="header clearfix element_to_stick">
		...
		<div id="logo">
			...
			<a href="index3.php?vs=<?php echo md5(rand()); ?>">
		...
		<nav class="main-menu">
			...
			<div id="header_menu">
				...
				<a href="index3.php?vs=<?php echo md5(rand()); ?>">KooFamilies</a>
			 ...
			 <ul>
				...
				<li class="submenu">
					...
					<ul class="">
						...
						<li><a href="index3.php?vs=<?php echo md5(rand()); ?>&language=english">English</a></li>

						<li><a href="index3.php?vs=<?php echo md5(rand()); ?>&language=chinese">Chinese</a></li>

						<li><a href="index3.php?vs=<?php echo md5(rand()); ?>&language=malaysian">Malay</a></li>  
...
map = new google.maps.Map($("#map")[0], {
   ...
   return result;
	...
	var r_url="https://koofamilies.com/index3.php?vs="+s_token;
