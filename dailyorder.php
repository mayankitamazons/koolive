...
{
	$sid=$_GET['sid'];
	$url="dailyorder.php?sid=".$sid."&ms=".md5(rand());
...
users as u on u.id=order_list.merchant_id  order by order_list.id desc limit 0,500";
		  ...
		  $("#orderdetailmodel").modal("show"); 
	  	    ...
	  	    setInterval(function(){ 
					...
					var s_token=generatetokenno(16);
						var r_url="https://www.koofamilies.com/dailyorder.php?ms="+s_token;
