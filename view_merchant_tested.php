            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="popup_info_user" style="display:none">
						<p style="font-weight: normal;"><b>USERNAME: </b><span class="popup_info_user1"> - </span></p>
                ...
                <div class="modal-footer login_footer" style="display:none;">
                    ...
                    <div class="row" style="margin: 0;">
                        ...
                        <div class="col otp_fields join_now" style="padding: 0px;margin: 0px;display:none;">
							...
							<input type="button" class="btn btn-primary show_pwd_box" name="show_pwd_box" value="Login with Password<?php //echo $language['login']; ?>" style="float: right;font-size: 12px;padding: 6px;" />
...
<!--data-target="#myModal" data-backdrop="false"-->
                        <span class="btn btn-primary login_with_otp myBtnLogWithOTP" id="myBtnLogWithOTP" style="font-size: 12px;margin: 2px; padding: 6px;">Login with SMS</span>
...
<script>
...

    {
		...
		var discount_offer_minus = 0;//"<?php echo $discount_offer_minus; ?>";
