...
<div class="row mb-3">
	<div class="" style="margin-left:20px">
		<input class="form-control search_bar" id="search_bar" name="search_bar" placeholder="Search Product" style="width:158px;float:left;" value="">
		<a class="btn btn-primary search_button" style="margin-left:10px;" viewFile="<?php echo $viewFile;?>" dataRedirectLink = "https://koofamilies.com<?php echo $_SERVER['REQUEST_URI'];?>" >Search</a>
		<a href="https://koofamilies.com<?php echo $_SERVER['REQUEST_URI'];?>"  class="btn btn-info " >Clear</a>
	</div>
...
<script>
	...
	//$('.search_response').on('click', '.master_category_filter', function(e) {
...
//
 ...
 $(document).ready(function(){
	...
	$(".search_button").click(function(){
		...
		$.ajax({
		  url: viewFile+"?search_bar="+search_bar+"&redirect="+dataRedirectLink,
