            ...
            <div class="row" id="main-content" style="">
			 <!-- <a style="text-align:center;width:100%;margin-top:2%;" href="https://play.google.com/store/apps/details?id=com.koobigfamilies.app" target="blank">
               ...
               <div class="col-md-12">
				  ...
				  <div class="clear"></div>
				  <h4 style="margin:0px;"> <?php echo $language['find_merchant']; ?>:</h4>
                  ...
                  <div class="col-md-12 test_test dollar">
                     <div class="col-md-3 test_qwertys" id="scan_qrcode">
                        <button class="btn btn-block btn-primary testts scan_code">  <?php echo $language['find_merchant']; ?> </button>
                     </div>
                     <div class="col-md-3 test_qwertys1" id="tele_number">
                        <button class="btn btn-block btn-primary testts tele_num"> <?php echo $language['telephone_number']; ?> </button>
                     </div>
                     <div class="col-md-3 test_qwertys2" id="merchant_name">
                        <button class="btn btn-block btn-primary testts merchant_nam"> <?php echo $language['merchant_name']; ?> </button>
                     </div>
                  </div>
                  <div class="col-md-12 test_test">
                     <div class="col-md-3 test_qwertys">
						 	<a href="#favourate_list" class="btn btn-block testts fav_list"> <?php echo $language['fav_list']; ?>
<!--
...
-->
                     ...
                     <div class="col-md-3 test_qwertys1">
						 	<a href="#favourate_list" class="btn btn-block testts fav_list"> <?php echo $language['near_by_shop']; ?>
                         </a>
<!--
...
border:3 px solid #fa7953;font-size:18px;background:red;color:black !important;margin-top: 3%;padding:10px;" href="index.php?vs=<?=md5(rand()) ?>"><?php echo $language['more_shops']; ?>
                   ...
                   <h4 style="margin:0px;"><?php echo $language['sacnning_qr_code']; ?></h4> 
					<h5 style="color:red;margin:0px;"><?php echo $language['scan_note']; ?></h5>
                  <div id="app">
                      <div class="sidebar">
                        ...
                        <section class="scans">
                          ...
                          <transition-group name="scans" tag="ul">
                		   <li style="display:none;" id="stl_scan" v-for="scan in scans" :key="scan.date" :title="scan.content">{{ scan.content }}</li>
                          </transition-group>
                  ...
                  <div class="well col-md-8 test_upload" id="test_upload">
                     <h4><?php echo $language['upload_qr']; ?></h4>
                     <form method="post">
                        ...
                        <br>
                        <button type="submit" name="GetData" class="btn btn-primary btn-block" onclick="window.location.href = 'structure_merchant.php';"><?php  echo $language['submit'];?></button>
                     </form>
                     <div class="common">
                        <?php
                           ...
                           <h3 class="text_mobile"><?php echo $language['mobile_number']; ?>: <strong><?php echo $row['mobile_number'];?> </strong></h3>
                        <h3 class="text_mobile"><?php echo $language['name']; ?>: <strong><a style="color:#09caab;" href="<?php echo $site_url;?>structure_merchant.php?sid=<?php echo $row['mobile_number'];?>">
						<?php echo $row['name'];?></a></strong> </h3>
                        <?php
                           }
                           } else {
                  ...
                  <div class="well col-md-8 test_mobile" id="test_mobile">
                     <h4><?php echo $language['mobile_number']; ?> </h4>
                     <form action="structure_merchant.php" method="post">
                        <?php 
                        ...
                        <input type="hidden" name="login_user_id" id="login_user_id" class="ct_ctycode" value="<?php echo $_SESSION['login'] ?>" />						
                  ...
                  <div class="well col-md-8 mer_nam" id="mer_name">
                     ...
                     <form action="structure_merchant.php" method="post">
                        ...
                        <!---new----->
                        <button class="btn btn-block btn-primary merchant_view"> <?php echo $language['view']; ?> </button>
                     </form>
                  </div>
                  <!-- end merchant name -->
                  <br>
                  ...
                  <div class="well col-md-8" id="favourate_list">
					...
					<button type="button" style="background:red;" class='btn btn-default nearby_restaurant_btn' user_id="<?php echo $user_id;?>">Click here to seach nearby shops.</button>
  ...
  window.addEventListener('load', function() {
    navigator.serviceWorker.register('/sw_new.js').then(function(registration) {
      ...
      console.log('ServiceWorker registration failed: ', err);
       ...
       $(".merchant_view2").click(function(e){
		   var s=$('#txtname2').val();
		   if(s=='')
		   {
			   $('#txtname2').focus();
	    ...
	    $(".merchant_view").click(function(e){
		   var s=$('#txtname').val();
		   if(s=='')
		   {
			   $('#txtname').focus();
...
<!-- adding new---->
    ...
    <script type="text/javascript" src="https://www.koofamilies.com/demo2/instascan-master/docs/app.js"></script> 
