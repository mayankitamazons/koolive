          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <span aria-hidden="true">&times;</span>
			  ...
			  <?php if($merchant_detail['custom_msg_image']){?>
                 ...
                 <img class="img-responsive" style="margin:0 auto;" src="<?php echo $image_cdn; ?>customimage/<?php echo $merchant_detail['custom_msg_image'];?>" alt="<?php echo $merchant_message; ?>">
...
border: 1px solid #fa7953;background:red;color:black !important;margin-top: 3%;padding:10px;" href="index.php?vs=<?=md5(rand()) ?>"><?php echo $language['more_shops']; ?>
                    ...
                    <h4 class="favorite_name" style="display: inline-blick;">
                       <?php if($merchant_detail['id']==6958 || $merchant_detail['id']==6956) {  ?>
...
<script src="js/sketch_new.js" ></script>
