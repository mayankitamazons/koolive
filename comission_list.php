...
$sql = "SELECT count(id) as total_count FROM comission_list WHERE user_id ='".$_SESSION['login']."'";
...
$left_rec = $rec_count - ($page * $rec_limit);
 $u_query="select comission_list.*,m.name as merchant_name,m.mobile_number as merchant_mobile_number,u.user_refferal_code from comission_list inner join users as m on comission_list.merchant_id=m.id 
inner join users as u on u.id=comission_list.user_id where comission_list.user_id ='".$_SESSION['login']."' ORDER BY comission_list.id DESC LIMIT $offset, $rec_limit";  
 $u_query=mysqli_query($conn,$u_query);
?>
...
<body class="header-light sidebar-dark sidebar-expand pace-done">
    ...
    <div id="wrapper" class="wrapper">
            ...
            <main class="main-wrapper clearfix" style="min-height: 522px;">
                ...
                <div class="row" id="main-content" style="padding-top:25px">
					...
					<div class="well" style="width:100%">
						...
						<h3><?php echo $language["comission_list"];?> <a href="addreffmerchant.php" class="btn btn-primary pull-right"><?php echo $language["add_refferal_code"];?></a></h3>
						...
						<table class="table table-striped kType_table dataTable no-footer" id="kType_table" aria-describedby="kType_table_info">
							...
							<tr>
								...
								<th><?php echo "Merchant Mobile Number";?></th>
								
								<th><?php echo "Refferal Link";?></th>
...

							{
								...
								<tr>
									...
									<td><?php echo $row['merchant_mobile_number']; ?></td>
								
									<td><?php echo $reffereal_link=$row['reffereal_link']; ?></td>

									<td>
									  <?php $share_link=urlencode("Hey use my link to place order on koofamilies $reffereal_link");
										$share_link=$language['ref_1']." ".$row['merchant_name']." ".$language['ref_2']." ".$language['ref_3']."\n".$reffereal_link;
										$share_link=urlencode($share_link);
									  ?>
									
										<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($row['reffereal_link']); ?>" title="Share on Facebook"  target="_blank">
        ...
        data-action="<?php echo urlencode($row['reffereal_link']); ?>"
        target="_blank">   
										
										  <i style="font-size:20px;" class="fa fa-whatsapp"></i>
										</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="https://twitter.com/intent/tweet?url=<?php echo urlencode($row['reffereal_link']); ?>&via=getboldify&text=<?php echo $share_link; ?>" target="_blank">   <i style="font-size:20px;" class="fa fa-twitter"></i> </a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="https://bitly.com/">Create Short Url</a>
									<td>
									
									<a class="mr-4" href="delete_comission_list.php?id=<?php echo $row['id'] ?>">
									<?php if ($row['status'] == '1'): ?>
