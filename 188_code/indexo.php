...

{
	...
	.load_parentcss {
		...
		<div id="logo">
			...
			<a href="indexo.php?vs=<?php echo md5(rand()); ?>">
		...
		<nav class="main-menu">
			...
			<div id="header_menu">
				...
				<a href="indexo.php?vs=<?php echo md5(rand()); ?>">KooFamilies</a>
			 ...
			 <ul>
				...
				<li class="submenu">
					...
					<ul class="">
						...
						<li><a href="indexo.php?vs=<?php echo md5(rand()); ?>&language=english">English</a></li>

						<li><a href="indexo.php?vs=<?php echo md5(rand()); ?>&language=chinese">Chinese</a></li>

						<li><a href="indexo.php?vs=<?php echo md5(rand()); ?>&language=malaysian">Malay</a></li>  
                ...
                while($rd=mysqli_fetch_assoc($result)){
			        ...
			        <div class="strip">
			            ...
			            <figure class="showLoader6">
			                ...
			                <a href="view_merchant.php?vs=<?=md5(rand()) ?>&sid=<?php echo $rd['mobile_number'];?>" class="strip_info showLoader6">
		...
		<?php
			$LocaSt="Kulai";
						...
						$LOCSQL = "and users.city='$LocaSt'" ;
							  ...
							  users.not_working_text,users.not_working_text_chiness,users.banner_image,users.working_text,users.working_text_chiness,users.shop_open FROM users 
						   ...
						   WHERE users.user_roles = 2 and users.isLocked= 0  $LOCSQL group by users.id order by users.name asc";      
				...
				<div class="col-12">
					...
					<div class="main_title version_2">
						...
						<div class="row">
							  ...
							  <div class="col-md-8"><h2><?php echo $language['near_by_shop_2']; ?> (<?php echo $count; ?>)</h2></div>
				...
				<div class="col-md-6">
					...
					<div class="list_home">
                        ...
                        ?>  <li>   
								...
								<a class="showLoader6" href="view_merchant.php?vs=<?=md5(rand()) ?>&sid=<?php echo $rd[$i][4];?>">
...
map = new google.maps.Map($("#map")[0], {
   ...
   return result;
	...
	var r_url="https://koofamilies.com/indexo.php?vs="+s_token;
