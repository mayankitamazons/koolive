...
echo utf8_decode($merchant_detail['name']);
echo '<br/><pre>';
...
*/
        ...
        img.lazy {
            ...
            background-image: url('http://188.166.187.218/img/logo.png');
    ...
    <main class="main-wrapper clearfix" style="min-height: 522px;">
        ...
        { ?>
                ...
                <?php
				 ...
				 <a onclick='EmptyCart()' class="empty_cart btn btn-danger" style="background: red none repeat scroll 0% 0%; color: rgb(255, 255, 255);"><?php echo $language['empty_cart']; ?></a>
            ...
            <div class="modal-body">
				...
				<p style="font-size: 14px;">
						<span style="font-weight: bold;"><?php  echo $language['i_1'];?> <span style="color:red;font-weight:bold;"> RM 0.0 </span>
								...
								The balance of RM <span id="payable_bal" style="color:red;"></span> can be paid by cash or internet banking </br>
...
{ ?>
    ...
    { ?>
                                ...
                                <button class="btn btn-large btn-danger trasfer_complete showLoader"><?php echo $language['transfer_complete']; ?><span>
...
$shortcut_icon = 'http://188.166.187.218/img/logo_512x512.png';
...
<script>
    $(window).on('load', function() {
        ...
        $('.lazy').lazy({
            ...
            placeholder: "http://188.166.187.218/img/logo.png"
        });
