						...
						<div class="col-md-12">
							<article class="blog">
								<div class="post_info">
									...
									<h2><a href="blog-post.html">Job Title</a></h2>
									...
									<ul >
										<li></li>
										<li style="padding-top:0;"><button class="btn_1">Interested</button></li>
									</ul>
								</div>
							</article>
							<!-- /article -->
						...
						<div class="col-md-12">
							<article class="blog">
								...
								<div class="post_info">
									...
									<ul >
										<li></li>
										<li style="padding-top:0;"><a href="blog-post.html"><button class="btn_1">Interested</button></a></li>
									</ul>
								</div>
							</article>
							<!-- /article -->
