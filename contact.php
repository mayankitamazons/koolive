						...
						<div class="well col-md-6" style="margin:0px auto;">
							<form method="post" onsubmit="return change_amount()">
								<div class="panel price panel-red" style="padding:20px 5px;">
									<h2>Contact</h2>
									<br>
									<h4 style="font-size:1.2rem">Kuala Lumpur : W505, West Wing, Metropolitan Square. </h4>
									<h5 style="font-size: 0.9rem">No.2, Jalan PJU 8/1, Damansara perdana ,</h5>
									<h5 style="font-size: 0.9rem">47820, Petaling Jaya,Selangor </h5>
									<h5 style="font-size: 0.9rem">Telephone : 012-3115670 </h5>
									<h5 style="font-size: 0.9rem">Telephone : 03-74935031 </h5>
