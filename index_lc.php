        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
					...
					{
					?>
					<!--<p><a data-dismiss="modal" href="" onclick="window.location.assign('https://www.koofamilies.com/index_lc.php?locationsort=<?php echo $data['CityName'] ?>') ; return false;"><button class="locationbutton btn btn-primary"><?php echo $data['CityName'] ?></button></a></p>
					-->
					<p><a href="javascript:void(0);" link="https://www.koofamilies.com/index_lc.php?locationsort=<?php echo $data['CityName'] ?>" class="locationbutton btn btn-primary"><?php echo $data['CityName'] ?></a></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form name="language_form" id="language_form">
					<a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=english" class="btn btn-primary btn_language" >English</a>
					<a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=chinese" class="btn btn-success btn_language" >华语</a>
					<a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=malaysian" class="btn btn-info btn_language" >Malay</a>
					<br/>
...
if(isset($_GET['code']) && isset($_GET['id']) && is_numeric($_GET['id']))
{
	...
	<header class="header clearfix element_to_stick">
		<div class="container">
		<div id="logo">
			<a href="index_lc.php?vs=<?php echo md5(rand()); ?>">
                <!-- koofamilies logo -->
		...
		<nav class="main-menu">
			<div id="header_menu">
				...
				<a href="index_lc.php?vs=<?php echo md5(rand()); ?>">KooFamilies</a>
			 ...
			 <!--li class="submenu"><a href="register.php" class="show-submenu" style="font-size:16px"><?php echo $language['register']; ?></a></li!-->
				...
				<li class="submenu">
					...
					<ul class="">
						...
						<li><a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=english">English</a></li>
						<li><a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=chinese">Chinese</a></li>
						<li><a href="index_lc.php?vs=<?php echo md5(rand()); ?>&language=malaysian">Malay</a></li>  
...
map = new google.maps.Map($("#map")[0], {
   ...
   return result;
	...
	var r_url="https://koofamilies.com/index_lc.php?vs="+s_token;
      ...
      console.log('ServiceWorker registration failed: ', err);
		...
		var show_flash="<?php echo $show_flash; ?>";
		  ...
		  if(show_flash)
		  {
			  ...
			  setTimeout(function(){ 
			  window.location.href = "index_lc.php";
			  },5000); 
		  }
